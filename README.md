...
> Safe css gradient generator and collection

[![npm version](https://badge.fury.io/js/safe-gradient-gen.svg)](https://www.npmjs.com/package/safe-gradient-gen)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install safe-gradient-gen
```

## Quick Start

```javascript
const { gen } = require('safe-gradient-gen');
...
```javascript
const { gen, batch } = require('safe-gradient-gen');
